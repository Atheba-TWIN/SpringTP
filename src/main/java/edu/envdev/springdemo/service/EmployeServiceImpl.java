...
public class EmployeServiceImpl implements EmployeService {
  ...
  public Employe findById(Integer id) {
    return repository.findById(id)
        .orElseThrow(() -> new ResourceNotFoundException("Employe non trouve avec id=" + id));
  }
  ...
  public Employe update(Integer id, Employe employe) {
    ...
    exist.setPrenom(employe.getPrenom());
    exist.setMatricule(employe.getMatricule());
    exist.setFonction(employe.getFonction());
  ...
  public void deleteById(Integer id) {
    if (!repository.existsById(id)) {
      throw new ResourceNotFoundException("Employe non trouve avec id=" + id);
    }
